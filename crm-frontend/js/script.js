...
async function getData() {
  ...
  data.forEach(function (oneObj){
    const oneObjFunc = createRow(oneObj)
  })
}
...
function createRow(obj) {
  ...
  mainID.textContent = obj.id
  mainFIO.textContent = `${obj.name} ${obj.surname} ${obj.lastName}`
  const createDD = obj.createdAt.slice(8, 10)
  const createMM = obj.createdAt.slice(5, 7)
  const createYear = obj.createdAt.slice(0, 4)
  const createTime = obj.createdAt.slice(11, 16)
  const changeDD = obj.updatedAt.slice(8, 10)
  const changeMM = obj.updatedAt.slice(5, 7)
  const changeYear = obj.updatedAt.slice(0, 4)
  const changeTime = obj.updatedAt.slice(11, 16)
  ...
  for (const oneSocial of obj.contacts) {
    if (oneSocial.value !== '-') {
  ...
  mainTableChangeBtn.addEventListener('click', async function() {
    ...
    for (const oneContact of getData.contacts) {
      if (oneContact.value !== '-' && number1 === false) {
        number1 = true
        selectValue1 = oneContact.type
        inputValue1 = oneContact.value
      } else if (oneContact.value !== '-' && number2 === false) {
        number2 = true
        selectValue2 = oneContact.type
        inputValue2 = oneContact.value
      } else if (oneContact.value !== '-' && number3 === false) {
        number3 = true
        selectValue3 = oneContact.type
        inputValue3 = oneContact.value
      } else if (oneContact.value !== '-' && number4 === false) {
        number4 = true
        selectValue4 = oneContact.type
        inputValue4 = oneContact.value
      } else if (oneContact.value !== '-' && number5 === false) {
        number5 = true
        selectValue5 = oneContact.type
        inputValue5 = oneContact.value
      } else if (oneContact.value !== '-' && number6 === false) {
        number6 = true
        selectValue6 = oneContact.type
        inputValue6 = oneContact.value
      } else if (oneContact.value !== '-' && number7 === false) {
        number7 = true
        selectValue7 = oneContact.type
        inputValue7 = oneContact.value
      } else if (oneContact.value !== '-' && number8 === false) {
        number8 = true
        selectValue8 = oneContact.type
        inputValue8 = oneContact.value
      } else if (oneContact.value !== '-' && number9 === false) {
        number9 = true
        selectValue9 = oneContact.type
        inputValue9 = oneContact.value
      } else if (oneContact.value !== '-' && number10 === false) {
        number10 = true
        selectValue10 = oneContact.type
        inputValue10 = oneContact.value
      }
    }
    ...
    changeSaveBtn.addEventListener('click', async function() {
      await changeSave(mainTableChangeBtn.closest('.main__tbody__tr').querySelector('.main__tbody__th-1').innerText, getData)
    })

    changeContactBtn.addEventListener('click', () => {
      countContactClick++
      if (number1 === true && document.querySelector('[data-change-1]').classList.contains('d-none') && inputValue1 !== '-') {
        document.querySelector('[data-change-1]').classList.remove('d-none')
        changeContactSelect1.value = selectValue1
        changeContactInput1.value = inputValue1
        number1 = false
      }
      if (number2 === true && document.querySelector('[data-change-2]').classList.contains('d-none') && inputValue2 !== '-') {
        document.querySelector('[data-change-2]').classList.remove('d-none')
        changeContactSelect2.value = selectValue2
        changeContactInput2.value = inputValue2
        countContactClick++
        number2 = false
      }
      if (number3 === true && document.querySelector('[data-change-3]').classList.contains('d-none') && inputValue3 !== '-') {
        document.querySelector('[data-change-3]').classList.remove('d-none')
        changeContactSelect3.value = selectValue3
        changeContactInput3.value = inputValue3
        countContactClick++
        number3 = false
      }
      if (number4 === true && document.querySelector('[data-change-4]').classList.contains('d-none') && inputValue4 !== '-') {
        document.querySelector('[data-change-4]').classList.remove('d-none')
        changeContactSelect4.value = selectValue4
        changeContactInput4.value = inputValue4
        countContactClick++
        number4 = false
      }
      if (number5 === true && document.querySelector('[data-change-5]').classList.contains('d-none') && inputValue5 !== '-') {
        document.querySelector('[data-change-5]').classList.remove('d-none')
        changeContactSelect5.value = selectValue5
        changeContactInput5.value = inputValue5
        countContactClick++
        number5 = false
      }
      if (number6 === true && document.querySelector('[data-change-6]').classList.contains('d-none') && inputValue6 !== '-') {
        document.querySelector('[data-change-6]').classList.remove('d-none')
        changeContactSelect6.value = selectValue6
        changeContactInput6.value = inputValue6
        countContactClick++
        number6 = false
      }
      if (number7 === true && document.querySelector('[data-change-7]').classList.contains('d-none') && inputValue7 !== '-') {
        document.querySelector('[data-change-7]').classList.remove('d-none')
        changeContactSelect7.value = selectValue7
        changeContactInput7.value = inputValue7
        countContactClick++
        number7 = false
      }
      if (number8 === true && document.querySelector('[data-change-8]').classList.contains('d-none') && inputValue8 !== '-') {
        document.querySelector('[data-change-8]').classList.remove('d-none')
        changeContactSelect8.value = selectValue8
        changeContactInput8.value = inputValue8
        countContactClick++
        number8 = false
      }
      if (number9 === true && document.querySelector('[data-change-9]').classList.contains('d-none') && inputValue9 !== '-') {
        document.querySelector('[data-change-9]').classList.remove('d-none')
        changeContactSelect9.value = selectValue9
        changeContactInput9.value = inputValue9
        countContactClick++
        number9 = false
      }
      if (number10 === true && document.querySelector('[data-change-10]').classList.contains('d-none') && inputValue10 !== '-') {
        document.querySelector('[data-change-10]').classList.remove('d-none')
        changeContactSelect10.value = selectValue10
        changeContactInput10.value = inputValue10
        countContactClick++
        number10 = false
      }
...
async function changeSave(id, data) {
  if (changeInputName.value.trim() !== '' && changeInputSurname.value.trim() !== '') {
    ...
    changeInputSurname.value = data.surname
    changeInputName.value = data.name
    changeInputLastName.value = data.lastName
    ...
    const patchResponse = await fetch(`http://localhost:3000/api/clients/${id}`, {
      method: 'PATCH',
      body: JSON.stringify({
        ...
        contacts: [
          {
            type: changeContactSelect1.value,
            value: changeContactInputValue1
          },
          {
            type: changeContactSelect2.value,
            value: changeContactInputValue2
          },
          {
            type: changeContactSelect3.value,
            value: changeContactInputValue3
          },
          {
            type: changeContactSelect4.value,
            value: changeContactInputValue4
          },
          {
            type: changeContactSelect5.value,
            value: changeContactInputValue5
          },
          {
            type: changeContactSelect6.value,
            value: changeContactInputValue6
          },
          {
            type: changeContactSelect7.value,
            value: changeContactInputValue7
          },
          {
            type: changeContactSelect8.value,
            value: changeContactInputValue8
          },
          {
            type: changeContactSelect9.value,
            value: changeContactInputValue9
          },
          {
            type: changeContactSelect10.value,
    ...
    console.log(await patchResponse)
